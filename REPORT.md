...
- 실험 11·12·13은 API 사용 제한으로 못 재다가 **한꺼번에** 다시 쟀다 — 아래 차이를 어느 변경의 몫으로 돌릴 수 없다
...
| 재측정을 실험 10 뒤 누적분(11·12·13)에 한꺼번에 했다 — 어느 변경의 몫인지 못 가른다 | 다음부터는 변경마다 재고, 못 잴 사정이면 그 변경을 미루기 |
