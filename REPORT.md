...
- **핵심 결과** (실험 16, 현재 코드 기준)
  - 분류 정확도 · macro F1(120건): **0.958 · 0.958** (실험 13 측정 — 15·16은 분류기를 건드리지 않았다)
  - 1턴 답변 적절성(46건, 두 번): **36 · 40** — 변경 전 코드(`65a3c41`) 재측정 40 · 38과 흔들림 범위(±2) 안
  - 1턴 건의 문항(8건, 두 번): **8 · 8** — 변경 전 7 · 7
  - 어려운 문항 통과(72건): **59/72** (실험 13 측정)
  - 여러 턴 대화 통과(12건, 두 번): **11 · 11**
- **남은 문제 3가지**
  ...
  2. 불만이 섞인 사용법 질문이 건의로 새는 오분류가 실험 10부터 재발한다(400002·400018)
