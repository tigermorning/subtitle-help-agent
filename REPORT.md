...
- 실험 11·12·13은 API 사용 제한으로 못 재다가 **한꺼번에** 다시 쟀다. 그래서 그 뒤에 **상태별로 갈라 다시 쟀다**(아래 '변경별로 갈라 재기')

| 지표 | 실험 10 | 실험 13 |
|---|---|---|
| 도구 호출 적절성 (1턴 46) | 44 · 45 /46 | **45/46** |
| 답변 적절성 (1턴 46) | 44 · 45 /46 | 43/46 |
| 둘 다 통과 (1턴 46) | 44 · 45 /46 | 43/46 |
| forbid 위반 | 0 · 0 | 1 (O-007 음역 지침 요약) |
| 분류 정확도 (분류 120) | 0.967 · 0.975 | 0.958 |
| 분류 정확도 (1턴 46) | 0.913 · 0.957 | 0.978 |
| 어려운 문항 통과 (72) | 60 · 61 | 59 |
| 여러 턴 대화 통과 (12) · 도구 집합 | 10 · 11 / 12 | 11 · 12 |

- **재는 도중에 평가 데이터의 명령줄 누출을 두 번 더 찾아 고쳤다.** 1차 측정(둘 다 40~41/46)은 그 누출이 섞인 값이다
...
- 주의
  - 위 행렬·F1은 **실험 10 시점** 값이다. 그 뒤 실험 11~13의 수치는 '재측정'·'변경별로 갈라 재기'에 있다
